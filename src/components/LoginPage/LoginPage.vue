            ...
            <div class="card-body">
                <div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input v-model="password" name="pwd" type="password" class="form-control form-control-lg" />
                            <span class="input-group-append">
                                <span class="input-group-text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-right">
                            <button v-on:click="loginClick" class="btn btn-primary mt-2">Sign In</button>
                        </div>
                    </div>
                </div>
            </div>
